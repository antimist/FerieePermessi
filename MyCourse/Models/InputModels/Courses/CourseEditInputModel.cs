...
namespace MyCourse.Models.InputModels.Courses
{
    public class CourseEditInputModel : IValidatableObject
    {
        ...
        [Required(ErrorMessage = "Il titolo è obbligatorio"),
         ...
         Remote(action: nameof(CourserController.IsTitleAviable), controller: "Courses", ErrorMessage = "Il titolo esiste già", AdditionalFields = "Id"),
         Display(Name = "Titolo")]
        ...
        {
            // appena compilaoto rimuovi il commento
            /*
